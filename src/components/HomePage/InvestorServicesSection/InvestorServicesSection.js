            ...
            <div className="card-content text-start">
              <div className='flex items-center gap-2 justify-between'>
                ...
                <div className="service-email">
                  ...
                  <a href="mailto:LetsNetwork@flippbidd.com?subject=FlippBidd%20Pro-services" className='text-xs'>LetsNetwork@flippbidd.com</a>
                </div>
              </div>
              ...
              <a href="mailto:LetsNetwork@flippbidd.com?subject=FlippBidd%20Pro-services" className="contact-button white-button"><span>Contact Us</span></a>
            </div>
          </div>
          ...
          <div className="service-card before:!bg-none before:!content-[''] before:!bg-slate-50 before:opacity-[0.8] lenders-card" style={{ backgroundImage: `url(${IMAGES.NATIONAL_LENDERS_BG})` }}>
            <div className="card-content text-start">
              <div className='flex items-center gap-2 justify-between'>
                ...
                <div className="service-email">
                  <img src={IMAGES.GRADIENT_MAIL} alt="Email" className="email-icon" />
                  <a href="mailto:LetsNetwork@flippbidd.com?subject=National%20Lenders" className='text-xs'>LetsNetwork@flippbidd.com</a>
                </div>
              </div>
              ...
              <a href="mailto:LetsNetwork@flippbidd.com?subject=National%20Lenders" className="contact-button gradient-button">Contact Us</a>
            </div>
          </div>
        </div>
      </div>
